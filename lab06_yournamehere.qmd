...
d.  Construct and graph a sampling distribution for the mean diameter for 1000 samples of size 10.  For the sampled means of tree diameter, also compute the mean and standard error.
